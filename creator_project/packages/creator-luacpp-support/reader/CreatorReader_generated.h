...
//	VT_SCALE = 30, //leon: not using
	...
	//const Vec2 *scale() const { return GetStruct<const Vec2 *>(VT_SCALE); } //leon: not using
...
//	void add_scale(const Vec2 *scale) { fbb_.AddStruct(Node::VT_SCALE, scale); }	//leon: not using
